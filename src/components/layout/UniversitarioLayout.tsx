...
import { UniversitarioNavigation } from "./UniversitarioNavigation"
import { useAuth } from "@/hooks/useAuth"
import { Navigate } from "react-router-dom"

const UniversitarioLayout = ({ children }: { children: React.ReactNode }) => {
...
export default UniversitarioLayout